...
- **Highly Customizable Styles**: Fully customize the caption aesthetics from the Settings window:
  - _Font Family_: Select between Avenir, Georgia, Helvetica Neue, Menlo, Futura, and more.
  - _Font Size_: Adjustable slider from 14pt to 60pt.
  - _Weight/Style_: Underline, Bold, and Italic modifiers.
  - _Colors_: Preset options including White, Yellow, Cyan, Green, Orange, and Pink.
...
4.  **Permissions**:
    ...
    - **Screen Recording / Audio Capture**: ScreenCaptureKit requires Screen Recording permission on macOS. Make sure to enable this in _System Settings > Privacy & Security > Screen Recording_ for LiveBuddy.
